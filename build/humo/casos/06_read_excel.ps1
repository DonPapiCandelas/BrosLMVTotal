# Caso de humo T4.1 #6: ctx.read_excel(). Puro I/O de archivo (openpyxl), sin UI. El propio
# script Python escribe y borra su archivo de prueba -- este .ps1 solo valida que el Runner
# haya terminado en 0 (las aserciones de contenido viven en el script, que truena si algo
# no cuadra).
param(
...
$AppKey = "HUMO_READ_EXCEL"
$codigoPath = Join-Path $PSScriptRoot "06_read_excel.codigo.py"
...
ELSE
    ...
    VALUES ('$AppKey', 'Humo T4.1 - ctx.read_excel()', '$codigoEscapado', 1, GETDATE());
"@
