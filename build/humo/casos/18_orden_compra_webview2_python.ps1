# Caso de humo #18: valida PLANTILLA_ORDEN_COMPRA_WEBVIEW2_PYTHON.py de punta a punta.
param(
...
$AppKey = "HUMO_ORDEN_COMPRA_WEBVIEW2_PYTHON"
$codigoPath = Join-Path $PSScriptRoot "18_orden_compra_webview2_python.codigo.py"
...
ELSE
    ...
    VALUES ('$AppKey', 'Humo - OC WebView2 (Python)', '$codigoEscapado', 1, GETDATE());
"@
...
$qConteo = "SELECT COUNT(*) FROM docDocument WHERE ModuleID=183"
