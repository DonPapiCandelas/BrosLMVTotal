# Caso de humo #19: valida PLANTILLA_ORDEN_COMPRA_WEBVIEW2_CSHARP.ctx de punta a punta.
param(
...
$AppKey = "HUMO_ORDEN_COMPRA_WEBVIEW2_CSHARP"
$codigoPath = Join-Path $PSScriptRoot "19_orden_compra_webview2_csharp.codigo.cs"
...
ELSE
    ...
    VALUES ('$AppKey', 'Humo - OC WebView2 (C#)', '$codigoEscapado', 1, GETDATE());
"@
